...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="css/bootstrap.min.css" />
  	<!-- <link rel="stylesheet" href="../css/b_sand.css" />  -->
  ...
  <jsp:include page="welcome_b.jsp"></jsp:include>
    <div class="container">
      ...
      <div class="card text-white bg-dark mb-3 mt-3">
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-8">
              <div class="row">
                <div class="col-3 fw-bold fs-5 text-success"><i class="bi bi-pin-angle"></i>주소 도로명</div>
                <div class="col lh-lg">서울특별시 영등포구 선유로 130</div>
              </div>
              <div class="row">
                <div class="col-3 fw-bold fs-5 text-success"><i class="bi bi-pin-angle"></i>지번</div>
                <div class="col lh-lg">양평동 3가 5-4번지</div>
              </div>
              <div class="row">
                <div class="col-3 fw-bold fs-5 text-success"><i class="bi bi-pin-angle"></i>건물명</div>
                <div class="col lh-lg">에이스 하이테크시티 3차</div>
              </div>
            </div>
            <!-- <div class="col-4">
      ...
      <div class="card text-white bg-dark mb-3 mt-5">
        <div class="card-header h3 text-center"><i class="bi bi-megaphone"></i> 원활한 관람을 위해서 <span style="color: red">대중교통 이용</span>을 부탁 드립니다.</div>
        <div class="card-body">
          <!-- 지하철 -->
          <div class="row">
            <div class="col-3 h5 fw-bold"><i class="bi bi-info-square" style="color: red"></i> 지하철</div>
            <div class="col-9">
              <div class="row mt-5">
                <div class="col-4 h5" style="color: #00b140">2호선</div>
                <div class="col-8">
                  <div class="row mt">
              ...
              <div class="row mt-5">
                <div class="col-4 h5" style="color: #fc4c02">3호선</div>
                <div class="col-8">
                  <div class="row">
              ...
              <div class="row mt-5">
                <div class="col-4 h5" style="color: #30e6ff">4호선</div>
                <div class="col-8">
                  <div class="row">
          ...
          <!-- 버스 -->
          <div class="row mt-5">
            <div class="col-3 h5 fw-bold"><i class="bi bi-info-square" style="color: red"></i> 버스</div>
            <div class="col-9">
              <div class="row mt-5">
